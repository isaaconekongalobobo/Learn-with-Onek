            ...
            <motion.svg className={style} whileHover={{rotate:25, y:-15, scale:1.2}} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32">
                <defs>
                    <radialGradient id="vscodeIconsFileTypePhp0" cx={-16.114} cy={20.532} r={18.384} gradientTransform="translate(26.52 -9.307)" gradientUnits="userSpaceOnUse">
                        <stop offset={0} stopColor="#fff"></stop><stop offset={0.5} stopColor="#4c6b96"></stop>
