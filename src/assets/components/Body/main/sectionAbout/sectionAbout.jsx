        ...
        <>
            <section className="bg-principale flex flex-col sm:flex-row p-5 text-sm sm:p-20  ">
                <div className="relative sm:w-texteSectionAcceuil">
                    ...
                    <p className="w-80 sm:w-full text-center sm:text-left">Venez apprendre gratuitement des langages de programation tel  que le <strong>HTML</strong>, le<strong>CSS3</strong>, le <strong>JavaScript</strong>, le <strong>Php</strong> et plein d&apos;autres... </p>
                </div>
                <GalleryLangages/>
            </section>
        </>
