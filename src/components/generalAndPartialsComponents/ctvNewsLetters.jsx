...
const CtvNewsLetters = () => {
    ...
    return (
        <motion.button className="bg-main-green py-3 px-5 flex items-center justify-center gap-3 rounded" onClick={()=> {navigate ('/newsletters')}} variants={btnVariant} whileHover={"whenHover"}>
            ...
            <span>{"S'abonner au newsletters"}</span>
        </motion.button>
    );
}
