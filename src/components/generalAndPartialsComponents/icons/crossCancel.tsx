...
const CrossCancel = ({ancre, action}) => {
    return (
        <>
        <Link to={ancre} >
            <motion.svg onClick={action} whileHover={{scale:1.3}} className='size-7 relative left-16 tablet:left-[450px]'  xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 15 15">
